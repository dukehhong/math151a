...
% save error into file with name filename
filename = './outputs/newton_output.txt';
fid = fopen(filename, 'w'); % file descriptor
fprintf(fid, "Newton's Method Error\n");
...
fprintf(fid, 'Newton Convergence Order Estimate\n');
