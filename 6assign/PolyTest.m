...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
fstring = '1 + (0.001)*(sin(1000*x))';   % target function specified by a string
...
h = plot(xxval,yExact,'b-'); % the target function 
axis([xPlotMin,xPlotMax,yPlotMin,yPlotMax]);
hold on;
h2 = plot(xxval,yApprx,'r-'); % the approx. function 
hold on;
h3 = plot(xval,fval,'ko'); % the interp. nodes 
